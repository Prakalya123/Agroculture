				...
				<?php
                    ...
                    <?php
                        while ($row = $result->fetch_array()):
	                        // Update the path to point to the ImagesAg folder
                       ...
                       <div class="col-md-4">
	                       <section>
		                        ...
		                        <a href="review.php?pid=<?php echo $row['pid']; ?>">
			                        <img class="image fit" src="<?php echo $picDestination; ?>" alt="<?php echo $row['product']; ?>" height="220px;" />
		                        </a>
		                        <div style="align: left">
									...
									<input type="number" name="qty" value="1" min="1" style="width: 60px;" required>
									<br>
		                        </div>
	                       </section>
                       </div>
