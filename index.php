...
<!-- Signup Form -->
<div class="3u 12u$(small)">
    <input type="radio" id="farmer-signup" name="category" value="1" checked>
    <label for="farmer-signup">Farmer</label>
</div>
<div class="3u 12u$(small)">
    <input type="radio" id="buyer-signup" name="category" value="0">
    <label for="buyer-signup">Buyer</label>
</div>
									</div>
									<center>
									<div class="row uniform">
